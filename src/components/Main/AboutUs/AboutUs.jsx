    ...
    <section>
      <div className={style.mainContainerAboutUs}>
        ...
        <div className={style.boxText}>
          <p>
            Все почалося з букета на день народження доньки — зробленого просто
            тому, що не було під рукою живих квітів. Відтоді кожна квітка
            ліпиться вручну, з тим самим теплом, як тоді, перший раз.
          </p>
        </div>
